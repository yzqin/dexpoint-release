...
from stable_baselines_dexpoint.common.preprocessing import get_flattened_obs_dim, is_image_space
from stable_baselines_dexpoint.common.type_aliases import TensorDict
from stable_baselines_dexpoint.common.utils import get_device
...
class PointNetImaginationExtractorGP(BaseFeaturesExtractor):
    def __init__(self, observation_space: gym.spaces.Dict, pc_key: str, feat_key: Optional[str] = None,
        ...
        if extractor_name == "smallpn":
            from stable_baselines_dexpoint.networks.pretrain_nets import PointNet
            self.extractor = PointNet()
        elif extractor_name == "mediumpn":
            from stable_baselines_dexpoint.networks.pretrain_nets import PointNetMedium
            self.extractor = PointNetMedium()
        elif extractor_name == "largepn":
            from stable_baselines_dexpoint.networks.pretrain_nets import PointNetLarge
